					...
					<div class="card mb-3">
						<div class="row g-0 align-middle my-auto">
							<div class="col-1 align-middle my-auto" style="width:180px;height:180px;">
								<a href="{{ route('detail',$order_history-> }}"> <img src="{{$cart_shop['kind']['product']['product_main_image']}}" alt="商品メイン画像" style="width:180px;height:180px;" class="object-fit-cover"></a>
							</div>
							<div class="col row">
